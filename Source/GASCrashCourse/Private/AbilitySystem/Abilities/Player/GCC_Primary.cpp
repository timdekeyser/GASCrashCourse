...
TArray<AActor*> UGCC_Primary::HitBoxOverlapTest()
{
...
void UGCC_Primary::SendHitReactEventToActors(const TArray<AActor*>& ActorsHit)
{
...
void UGCC_Primary::DrawHitBoxOverlapDebugs(const TArray<FOverlapResult>& OverlapResults, const FVector& HitBoxLocation) const
{
